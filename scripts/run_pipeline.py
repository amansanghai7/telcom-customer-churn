...
def main(args):
    ...
    mlflow.set_tracking_uri("file:///E:/Data Field Study Material/Projects/Telecom Customer Churn/mlruns")
    ...
    with mlflow.start_run():
        ...
        # Create input example for model signature (suppress integer missing value warnings)
